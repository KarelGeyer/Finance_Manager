...
namespace PortfolioService.Interfaces.Services
{
    ...
    {
        /// <summary>
        /// Call common db service to retrieve all entities for for given range of users.
        /// </summary>
        /// <param name="userIds">ids of users in a group</param>
        /// <returns>List of <see cref="CommonPortfolioModel"/> entities</returns>
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="Exception"></exception>
        Task<List<T>> GetAllPortfolioEntitiesByGroup(int[] userIds);
